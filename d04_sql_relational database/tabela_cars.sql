...
-- Zrzut struktury bazy danych cars
CREATE DATABASE IF NOT EXISTS `cars` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci */;
USE `cars`;

-- Zrzut struktury tabela cars.cars
